...
- `~/Projects/public/gitme/` (clone of [davorg/gitme](https://github.com/davorg/gitme)) for quick git repo jumping; sourced at shell startup by `30_bash_autocomplete` / `30_zsh_autocomplete`
