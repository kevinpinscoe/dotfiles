...
echo "  VS Code settings.json / snippets — platform-specific paths, copy.sh / restore.sh"
echo "  (home-projects.code-workspace IS stowed — see the vscode-personal package)"
echo ""
