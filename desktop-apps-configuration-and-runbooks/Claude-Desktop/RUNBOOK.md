...
Claude Desktop provides a native desktop UI for Claude. There is no official Linux package — on Fedora the community RPM maintained by [aaddrick](https://github.com/aaddrick/claude-desktop-debian) is used.

## Install

### Fedora (community RPM)
...
The RPM does not start the workspace daemon. Apply the wrapper immediately after install — see [problems-and-fixes/vm-crashing/README.md](problems-and-fixes/vm-crashing/README.md) for full background.
...
### VM service crash loop on startup

See [problems-and-fixes/vm-crashing/README.md](problems-and-fixes/vm-crashing/README.md) for full diagnosis and the wrapper fix rationale.
