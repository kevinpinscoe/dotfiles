...
fastfetch --pipe false 2>/dev/null \
  ...
  | sed 's|<head>|<head><style>body{background-color:#0d1117;color:#c9d1d9;font-family:"JetBrains Mono","Fira Code","SF Mono","Menlo",monospace;font-size:14px;padding:24px 32px;margin:0;white-space:pre}pre{margin:0;}</style>|' \
  > "$TMPHTML"
